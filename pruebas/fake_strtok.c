 ...
 * contains one delimiter
 * @str: pointer to a char string received
 * @character: char received
 * Return: 0 if is NULL or 1 if found coincidence
 */
...
/**
 * count_until - count characters until before delimiter
 * @strUntil: string that contains delimiter
 * @str: char variable that contains string
...
/**
 * cp_until - create an array with characters that exist before
 * delimiter
